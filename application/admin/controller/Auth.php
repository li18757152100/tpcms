...
/*
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `fly_auth_rule`;
  CREATE TABLE `fly_auth_rule` (
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `fly_auth_group`;
  CREATE TABLE `fly_auth_group` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
